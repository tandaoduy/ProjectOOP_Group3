...
{
    public class ThongKeController : UserBaseController
    {
        private ProjectOOP_Nhom3Entities1 db = new ProjectOOP_Nhom3Entities1();

        // GET: User/ThongKe - Thống kê phiếu yêu cầu theo tháng hoặc ngày
        ...
        // GET: User/ThongKe/Chart - Biểu đồ thống kê
        ...
        // GET: User/ThongKe/ExportExcel - Export thống kê ra Excel
        [HttpGet]
